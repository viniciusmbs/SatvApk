...
class SoundService {
  ...
  private async initAudio() {
    ...
    // Load selection sound in background (BotaoRadio.mp3)
  ...
  /**
   * SOM 1: Som ao navegar com o cursor / D-Pad desativado para máxima fluidez no Fire TV Stick
   */
  public playNav(_volume = 0.5) {
    // No-op para evitar atrasos e travamentos de áudio ao navegar rapidamente com o D-Pad
  }

  /**
   * SOM 1 (Scroll): Som ao descer/subir a tela desativado para fluidez
   */
  public playScroll(_volume = 0.4) {
    // No-op para máxima fluidez
  }
