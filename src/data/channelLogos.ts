...
export const DEFAULT_LOGOS_MAP: Record<string, string> = {
  ...
  'PREMIERE 2': makePremiereBadge(2),
  'PREMIERE 3': makePremiereBadge(3),
  'PREMIERE 4': makePremiereBadge(4),
  'PREMIERE 5': makePremiereBadge(5),
  'PREMIERE 6': makePremiereBadge(6),
  'PREMIERE 7': makePremiereBadge(7),
  'PREMIERE 8': makePremiereBadge(8),
  'PREMIERE 8 MOSAICO': makePremiereBadge(8),
  'DAZN': `${TV_LOGO_US}dazn-us.png`,
  'DAZN 2': makeDaznBadge(2),
  'DAZN 3': makeDaznBadge(3),
  'DAZN 4': makeDaznBadge(4),
  'DAZN 6': makeDaznBadge(6),
  'DAZN 7': makeDaznBadge(7),
  'DAZN 8': makeDaznBadge(8),
  'DAZN 9': makeDaznBadge(9),
  'DAZN 10': makeDaznBadge(10),
  'CAZÉ TV': CAZE_TV_SVG,
  'CAZE TV': CAZE_TV_SVG,
  'CAZETV': CAZE_TV_SVG,
...
export const getChannelLogo = (
  ...
  // DAZN (canais 1 a 10)
  if (upper.includes('DAZN 10')) return makeDaznBadge(10);
  if (upper.includes('DAZN 9')) return makeDaznBadge(9);
  if (upper.includes('DAZN 8')) return makeDaznBadge(8);
  if (upper.includes('DAZN 7')) return makeDaznBadge(7);
  if (upper.includes('DAZN 6')) return makeDaznBadge(6);
  if (upper.includes('DAZN 4')) return makeDaznBadge(4);
  if (upper.includes('DAZN 3')) return makeDaznBadge(3);
  if (upper.includes('DAZN 2')) return makeDaznBadge(2);
  if (upper.includes('DAZN')) return `${TV_LOGO_US}dazn-us.png`;

  // Premiere (canais 1 a 8)
  if (upper.includes('PREMIERE 8')) return makePremiereBadge(8);
  if (upper.includes('PREMIERE 7')) return makePremiereBadge(7);
  if (upper.includes('PREMIERE 6')) return makePremiereBadge(6);
  if (upper.includes('PREMIERE 5')) return makePremiereBadge(5);
  if (upper.includes('PREMIERE 4')) return makePremiereBadge(4);
  if (upper.includes('PREMIERE 3')) return makePremiereBadge(3);
  if (upper.includes('PREMIERE 2')) return makePremiereBadge(2);
